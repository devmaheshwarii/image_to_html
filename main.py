...
model.fit([features, html_input], next_words, batch_size=2, shuffle=False, epochs=100)
...
generated_html = "<html><body><h1></h1><p>hello world</p></body></html>"

with open("output.html", "w") as f:
    f.write(generated_html)

print("HTML file saved as output.html. Open it in a browser.")
